    ...
    <div className="flex h-full w-full flex-col p-4">
      ...
      {editing ? (
        <Textarea
          ...
          rows={2}
          className="bg-transparent text-3xl! font-bold px-0 py-2 text-white resize-none border-none focus-visible:ring-0"
        />
      ) : (
        <h1
          ...
          {value || '(NO TITLE)'}
          <Pencil className="size-4 opacity-0 group-hover:opacity-60 transition-opacity" />
        </h1>
      )}
      {
      moment.created_at && (
